...
from app.bridge.email import Email
from app.bridge.sms import SMS
from app.bridge.notificacion_viaje import NotificacionViaje
from app.bridge.notificacion_emergencia import NotificacionEmergencia
from app.decorators.tarifa_base import TarifaBase
from app.decorators.peaje import Peaje
from app.decorators.nocturno import Nocturno
from app.decorators.seguro import Seguro
from app.facade.facade_viaje import FacadeFinalizarViaje
...
def crear_viaje_builder(datos: SolicitudViaje):
    ...
    from app.builders.viaje_builder_concreto import ViajeBuilder
